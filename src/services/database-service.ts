...
import createJourneyModel, { JourneyInstance } from '../models/journey-model';
...
export default class DatabaseService extends Service {
  ...
  public readonly journeys: Model<JourneyInstance>;
  ...
  public constructor(container: ServiceContainer) {
    ...
    this.journeys = createJourneyModel(container, this.mongoose);
  }
